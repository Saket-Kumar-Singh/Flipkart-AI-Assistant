...
exports.getProductByEmbeddings = asyncErrorHandler(async (req, res, next) => {
    ...
    const summarizer = genAI.getGenerativeModel({
        ...
        it should be blue then the model will summarize it as \"A Blue Dress\" you just give the description of product user wants and nothing more like A Blue Dress. Identify the needs of customer and if like the request till now was related to some toy camera and then they starts asking for a new type of product then remove all of the previous summary and make the new summary as the type of product they need.",
    });
